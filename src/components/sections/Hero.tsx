...
const heroContent: Record<string, {
  ...
  // 合作伙伴细分 - 投资人参考 Q4-1 核心逻辑
  'partner-investor': {
    badge: '投资人专属',
    title: ['课堂数据', '唯一入口'],
    subtitle: '逻辑已闭环，爆发前夜，克制且精准',
    description: 'MeetMind 的核心背书是"已在本地跑通的数据生产线"——45分钟课堂音频→300字精准陪学脚本。清华技术+北师大教育+深圳落地的黄金三角团队，确保从实验室到教室的最后一公里可落地。2026年是窗口期，我们正在完成数据冷启动的爆发临界点。',
    cta: '了解投资机会',
  },
  'partner-channel': {
    badge: '渠道商专属',
    ...
    description: 'MeetMind 已完成技术闭环，正处于数据冷启动的爆发临界点。我们提供完善的产品支持、培训体系和分润机制，寻找志同道合的区域合作伙伴，共同开拓这片千亿级市场。',
    cta: '了解代理政策',
  },
  // 默认
  default: {
