...
const heroContent: Record<string, {
  ...
  'partner-investor': {
    badge: '投资人专属',
    title: ['个性化学习', '基础设施'],
    subtitle: '不是工具，是下一代学习操作系统',
    description: 'MeetMind 正在构建个性化学习的双引擎架构：学习者画像引擎（教育专属记忆大模型）+ 上下文理解引擎（多模态场景接入）。在此之上生长出三个角色：老师的 AI 助教、学生的 AI 同桌、机构的增长引擎。就像安卓让每台手机都独一无二，我们要让每个学习者都有专属的学习操作系统。',
    cta: '了解投资机会',
  },
  'partner-channel': {
    badge: '渠道商专属',
    ...
    description: 'MeetMind 正在构建个性化学习的双引擎架构：学习者画像引擎 + 上下文理解引擎。通过 AI 助教、AI 同桌、增长引擎三个角色，打造下一代学习基础设施。寻找志同道合的区域合作伙伴。',
    cta: '了解代理政策',
  },
  // 默认
  default: {
