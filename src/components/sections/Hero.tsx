...
const heroContent: Record<string, {
  ...
  // 合作伙伴细分 - 投资人版本：强调基础设施定位
  'partner-investor': {
    badge: '投资人专属',
    title: ['个性化学习', '基础设施'],
    subtitle: '从工具到基础设施的演进',
    description: 'MeetMind 正在构建个性化学习的双引擎架构：学习者画像引擎（教育专属记忆大模型）+ 上下文理解引擎（多模态场景接入）。在此之上生长出三个应用：老师的 AI 助教、学生的 AI 同桌、机构的增长引擎。先做透课堂场景，再横向拓展，最终成为个性化学习的底层基础设施。',
    cta: '了解投资机会',
  },
  'partner-channel': {
    badge: '渠道商专属',
    ...
    description: 'MeetMind 正在构建个性化学习的双引擎架构：学习者画像引擎 + 上下文理解引擎。通过 AI 助教、AI 同桌、增长引擎三个应用，从课堂场景切入，逐步成为个性化学习的基础设施。寻找志同道合的区域合作伙伴。',
    cta: '了解代理政策',
  },
  // 默认
  default: {
