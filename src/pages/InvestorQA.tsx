    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 py-20">
        <div className="max-w-5xl">
          <span className="text-amber-500 text-sm font-medium tracking-[0.3em] uppercase mb-8 block">
            Q1 · Strategic Challenge
          </span>
          
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight mb-12">
            公立校对电子设备管控极严，
            <br />
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 bg-[#0c0c0c]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">1. 硬件形态与技术底层支撑</h2>
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">技术底层：锁定老师音轨</h2>
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 bg-[#0c0c0c]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">商业策略的"特洛伊木马"</h2>

          <QuoteBlock>
            进校的核心阻力在老师。我们的产品是为老师提供价值，逻辑核心在于"利他"。
          </QuoteBlock>

          <h3 className="text-xl font-semibold mb-6 text-gray-300">AI 工具为老师提供的价值：</h3>
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">全维度的合规性体系</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-[#111] rounded-2xl p-6 border border-gray-800">
              ...
              <p className="text-sm text-gray-400">产品定位为<Highlight color="green">"个人学习辅助工具"</Highlight>（类比纸质错题本或录音笔），确保原始录音不进行社交平台传播，数据本地化存储，原始音频在生成结构化摘要后，可设置定时自动销毁，从底层逻辑上尊重并保护教师授课的知识产权。</p>
            </div>

            <div className="bg-[#111] rounded-2xl p-6 border border-gray-800">
              <CheckCircle2 className="h-8 w-8 text-green-400 mb-4" />
              <h3 className="text-lg font-bold text-white mb-3">程序合规</h3>
              <p className="text-sm text-gray-400">遵循国家安全标准。通过与科研机构合作课题或地方教育局<Highlight color="green">"新技术试点"</Highlight>名义进入官方白名单。</p>
            </div>

            <div className="bg-[#111] rounded-2xl p-6 border border-gray-800">
              <Building2 className="h-8 w-8 text-green-400 mb-4" />
              <h3 className="text-lg font-bold text-white mb-3">资产合规</h3>
              <p className="text-sm text-gray-400">在公立体系我们采取<Highlight color="green">"资产分离"</Highlight>原则。基座作为学校"智慧校园资产"由校方采购；胶囊作为"个人学习用品"由家长自愿购买，规避乱收费红线。</p>
            </div>

            <div className="bg-[#111] rounded-2xl p-6 border border-gray-800">
              <BarChart3 className="h-8 w-8 text-green-400 mb-4" />
              <h3 className="text-lg font-bold text-white mb-3">政策合规</h3>
              <p className="text-sm text-gray-400">响应"双减"号召。定位是<Highlight color="green">"校内课堂提质增效"</Highlight>，减少无效刷题和盲目的校外补习行为，与"双减"政策中"强化学校教育主阵地、提升课堂质量"的目标高度一致。</p>
            </div>
          </div>
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 bg-[#0c0c0c]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">全场景分层策略</h2>
                  ...
                  <div className="bg-green-950/20 rounded-xl p-6 border border-green-900/50">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">合规的"伴读"视角：不通过实时监控（侵犯隐私），而是通过"认知切片"和"作业辅导指引"，让家长在家庭辅导时能精准衔接学校进度，不再"瞎辅导、乱发火"。</p>
                      </div>
                      <div>
                        <h5 className="font-semibold text-white mb-1">对于学校（数字化实绩）</h5>
                        <p className="text-sm text-gray-400">无感采集，合规落地：解决了"数据怎么来"的难题。在不改变老师教学习惯、不引入学生分心设备的前提下，实现了常态化的课堂数据留存。</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 text-sm">
                    <div className="bg-[#0a0a0a] rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-400">不直接向家长推销，而是先攻克老师。通过科研课题或教改试点的名义，向班主任/骨干教师赠送或低价提供"AI 助教系统"。一旦老师体验到"不用写教案摘要"、"家长咨询量下降 80%"的甜头，老师会产生路径依赖。</p>
                    </div>
                    <div className="bg-[#0a0a0a] rounded-lg p-4 border border-gray-800">
                      <h5 className="font-semibold text-white mb-2">2. 数据生态倒逼（Student Follows）</h5>
                      <p className="text-gray-400">当课堂数字化成为老师的"标准工作流"，老师会倾向于建议家长配备胶囊，以便学生能接收到"个性化错题集"和"针对性辅导资源"。</p>
                    </div>
                    <div className="bg-[#0a0a0a] rounded-lg p-4 border border-gray-800">
                      <h5 className="font-semibold text-white mb-2">3. 资产分离（规避红线）</h5>
                      <p className="text-gray-400">学校/教育局只需采购极少量的教师端设备或 SaaS 服务（低预算，甚至免费试用），规避了复杂的招投标和巨额预算审批；学生端设备定义为"个人文具"，由家长在校外渠道自愿购买。</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-red-950/20 rounded-xl p-6 border border-red-900/50">
                    ...
                    <p className="text-gray-400">家长高付费，对教学服务的精细度要求极高，学校需要证明"钱花得值"。</p>
                  </div>
                  <div className="bg-green-950/20 rounded-xl p-6 border border-green-900/50">
                    <h4 className="text-green-400 font-semibold mb-3">价值</h4>
                    <p className="text-gray-400">为学校提供"可视化教学质量报告"，助力学校实现教学质量数字化留存，构建学生个性化成长档案。强调"教学质量透明化"与"教学个性化"，作为服务溢价的工具。</p>
                  </div>
                </div>
            ...
            {activeTab === 2 && (
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-red-950/20 rounded-xl p-6 border border-red-900/50">
                    <h4 className="text-red-400 font-semibold mb-3">痛点</h4>
                    <p className="text-gray-400">培训班最大的问题是"黑盒"，家长交了钱不知道孩子听懂没，续费难。</p>
                  </div>
                  <div className="bg-green-950/20 rounded-xl p-6 border border-green-900/50">
                    <h4 className="text-green-400 font-semibold mb-3">价值</h4>
                    <p className="text-gray-400">我们帮机构把"教学过程透明化"，解决课后信息反馈断层问题。机构利用胶囊可以"今日学习高光时刻"用以宣传，提升教学透明度、续费率和报课率。</p>
                  </div>
                </div>
                <div className="bg-[#0a0a0a] rounded-xl p-4 border border-gray-800">
                  <h4 className="font-semibold text-white mb-2">进校逻辑</h4>
            ...
            {activeTab === 3 && (
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-red-950/20 rounded-xl p-6 border border-red-900/50">
                    <h4 className="text-red-400 font-semibold mb-3">痛点</h4>
                    <p className="text-gray-400">大学生家教/上门私教，家长无法全程监控，担心家教"水时长"。</p>
                  </div>
                  <div className="bg-green-950/20 rounded-xl p-6 border border-green-900/50">
                    <h4 className="text-green-400 font-semibold mb-3">C端价值</h4>
                    <p className="text-gray-400">家长直接购买设备给孩子。针对 1 对 1 辅导，家长可通过设备记录辅导过程，确保教学质量，还可以将昂贵的家教内容沉淀为可搜索、可回访的数字资产，保障学习质量。</p>
                  </div>
                </div>
              </div>
            )}
