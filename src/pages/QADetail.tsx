  ...
  return (
    <section className="py-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="bg-[#111] rounded-xl p-6 border border-gray-800 inline-block">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="flex items-center gap-2 text-white hover:text-amber-400 transition-colors bg-gray-800/50 hover:bg-gray-800 px-4 py-2 rounded-lg"
            >
      ...
      <section className="pt-32 pb-16 px-6 md:px-12 lg:px-24">
        <div className="max-w-5xl mx-auto">
          ...
          {isQ1 ? (
            ...
            <>
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight mb-8 text-gray-400">
                回答完善中...
              </h1>
              
              <div className="bg-gradient-to-r from-gray-500/10 via-gray-500/5 to-transparent border-l-4 border-gray-500 pl-8 py-8 pr-6 rounded-r-2xl">
